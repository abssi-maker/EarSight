"""Transcriber service stub — consumes earsight.jobs, logs, produces to earsight.transcript."""
import threading
...
def _handle(msg: dict) -> None:
    ...
    print(f"[transcriber] received job {job_id} — stub, no-op")
...
@app.get("/")
def root():
    return {"service": "transcriber", "version": "0.1.0"}
